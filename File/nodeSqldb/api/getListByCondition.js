...
function getListByCondition(req, res) {
    ...
    if (productName) {
        connection.query("SELECT * FROM product where product_name = " + productName,function (error, results, fields) {
        ...
        connection.query("SELECT * FROM product where product_type ="+productType,function (error, results, fields) {
            if (error) throw error;
        ...
        connection.query("SELECT * FROM product where product_name ="+productName+" and product_type = "+ productType,function (error, results, fields) {
            if (error) throw error;
